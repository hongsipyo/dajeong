...
export const FRAGMENTS: FragmentData[] = [
  ...
  // 세계관 — 오행/속성 시스템
  { id: "f43", content: "속성이 물이라서 물에 닿으면 기분이 좋아짐. 퍼포먼스가 안 좋아서 보니 알고보니 옷이 황토 재질이었음(혹은 불 그림). 사람의 '속성' — 물/불/흙 등이 있고, 이게 실생활에 영향.", tags: ["세계관", "오행", "속성"], type: "text", createdAt: "2026-05-15" },
  { id: "f44", content: "사물들은 모두 도움을 준다! 잘 정돈하고 매만지면. → 다정이 ADHD와 연결: 정리하면 사물이 도와주는데, 정리를 못 하니까 도움을 못 받음.", tags: ["세계관", "ADHD", "사물"], type: "text", createdAt: "2026-05-15" },
  { id: "f45", content: "어제와 오늘 사이엔 수많은 시공간이 있는데, 이 열차는 대개 탈선하지 않음. 자다가 죽을 경우, 탈선하기도 함. → 잠과 꿈의 메커니즘.", tags: ["세계관", "꿈", "수면"], type: "text", createdAt: "2026-05-15" },
  { id: "f46", content: "아기 때의 기억이 지워지는 이유 — 그때는 세상의 비밀을 알고 있기 때문에. 꿈을 잊게 되는 이유도 같음. → 할머니가 보이는 것과 연결.", tags: ["세계관", "기억", "할머니"], type: "text", createdAt: "2026-05-15" },
  { id: "f47", content: "어릴때 가진 신성을 소음으로 뒤덮는다. 목표는 신성 잃지 않기. → 다정이가 어른이 되면서 할머니가 안 보이게 되는 이유?", tags: ["세계관", "신성", "할머니"], type: "text", createdAt: "2026-05-15" },
  { id: "f48", content: "프루스트의 마들렌처럼 찰나에 오는 것들. 눈꺼풀 뒤에 있는 것들. → 파편이라는 개념 자체가 이것. 다정이가 갑자기 뭔가 떠올리는 순간들.", tags: ["세계관", "파편", "프루스트"], type: "text", createdAt: "2026-05-15" },
  { id: "f49", content: "파스칼: '오직 보기를 원하는 자에게는 충분한 빛이 있고, 이와 반대되는 마음을 가진 자들에게는 충분한 어둠이 있다.' → 할머니가 다정이에게만 보이는 이유. 라이프오브파이와 연결.", tags: ["세계관", "할머니", "파스칼"], type: "text", createdAt: "2026-05-15" },
  { id: "f50", content: "무엇이든 그것만 기다리고 있는 자에게는 그것이 오지 않는다. 마치 전여친의 연락처럼.", tags: ["세계관", "대사"], type: "text", createdAt: "2026-05-15" },
  { id: "f51", content: "누구나 입이 가벼운 자에게는 비밀을 맡기고 싶지 않아 하는 법이다. → 세상의 비밀을 아는 사람들이 말하지 않는 이유.", tags: ["세계관", "비밀"], type: "text", createdAt: "2026-05-15" },
  { id: "f52", content: "탁월한 문장은 언어를 통해 기쁨을 주고 슬픔을 가져간다. 마법이 가진 두 가지 기술 — 영혼을 혼란시키고 생각을 속이는 것. -고르기아스 → 다정이의 글쓰기/픽사 꿈과 연결", tags: ["세계관", "고르기아스", "글쓰기"], type: "text", createdAt: "2026-05-15" },
  { id: "f53", content: "알고 싶은 것보다 모르고 싶은 게 더 많아지는 시기를 지나고 있었다. → 다정이 20대 후반.", tags: ["테마", "성장"], type: "text", createdAt: "2026-05-15" },
  { id: "f54", content: "어른이란 많은 실수를 저지른 사람을 일컫는다는데, 이 정의에 따르면 그들은 불혹을 넘어선 나이에 어른이 되기 위해 도저하게 나아가고 있는 것이었다.", tags: ["테마", "어른"], type: "text", createdAt: "2026-05-15" },
];
